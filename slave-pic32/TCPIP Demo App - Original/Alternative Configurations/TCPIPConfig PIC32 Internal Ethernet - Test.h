...
#define MY_DEFAULT_PRIMARY_DNS_BYTE1	(4ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE2	(4ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE3	(4ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE4	(4ul)
 ...
 */
	...
	#define TCP_PIC_RAM_SIZE					(6480ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] = 
		{
			...
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 1500, 1500},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 1596, 1596},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 1596, 1596},
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_PIC_RAM, 1500, 1500},
		};
